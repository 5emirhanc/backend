...
export const beadProdut = async (req, res) => {
  try {
    const file = await beadProducts.findOne();
    console.log(file);
    res.json(file);
  } catch (err) {
    res.json({ message: err.message });
...
export const kitchenProduct = async (req, res) => {
  try {
...
export const seatProduct = async (req, res) => {
  try {
    const file = await seatProducts.findAll();
    console.log(file);
    res.json(file);
  } catch (err) {
    res.json({ message: err.message });
...
export const stateProduct = async (req, res) => {
  try {
    const file = await stateProducts.findAll();
    console.log(file);
    res.json(file);
  } catch (err) {
    res.json({ message: err.message });
